...
\newcommand{\myPaperTitleWithoutBreaks}{A Branch- and Bound Method for Bilevel Parallel Machine Scheduling with Adversarial Job Selection}
...
\newcommand{\myCourseOfStudies}{Mathematics (M.Sc.)}
...
\newcommand{\myAcknowledgement}{%
I acknowledge the use of AI-based assistants, specifically GitHub Copilot (GPT-4.1) and Anthropic Claude (Claude Opus 4.6, Claude Sonnet 4, Claude Sonnet 4.6), to support code generation, LaTeX editing, and language improvements during the preparation of this thesis. All content was critically reviewed and finalized by myself.
}  % Optional
...
% PGFPlots for axis environment and plots
\usepackage{pgfplots}
...
\AtBeginDocument{
    ...
    % Appendix redefinition commented out - was causing chapters to be numbered as appendices
    % \makeatletter
...
\ifdefstring{\tubs@language}{german}
{
    ...
    I hereby declare in lieu of an oath that I have written this master thesis „\myPaperTitleWithoutBreaks" independently and that I have cited all sources and aids used in full and that the thesis has not already been submitted as an examination paper.
